...
export default function ContractorForm({ contractor, companies }: ContractorFormProps) {
  ...
  const { data, setData, post, put, processing, errors, reset } = useForm({
    ...
    company_id: contractor?.company_id?.toString() || '',
  });
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: isEdit ? 'Edit Contractor' : 'Add Contractor', href: '#' },
  ];

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={isEdit ? 'Edit Contractor' : 'Add Contractor'} />
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              {isEdit ? 'Edit contractor details' : 'Create a new contractor'}
            </p>
          </CardHeader>
