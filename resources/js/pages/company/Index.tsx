...
export default function CompanyIndex({ companies, filters }: Props) {
  ...
  const handleSearchKey = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      router.get('/company', { ...filters, search }, { preserveScroll: true });
    }
  };
      ...
      <div className="flex-1 p-4 md:p-6">
        <Card>
          ...
          <CardContent className="pt-6 space-y-6">
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {!companies || companies.data.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="p-4 text-center text-muted-foreground">No companies found.</td>
                    </tr>
                  ) : (
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Company <strong>{company.name}</strong> will be permanently deleted.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
            ...
            {!companies || companies.links.length > 1 && (
