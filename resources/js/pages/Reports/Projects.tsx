                            ...
                            <CardHeader className="p-1.5 pb-0 shrink-0">
                                    ...
                                    {[
                                        ...
                                        >
                                            ...
                                            <div className="min-w-0">
                                                <p className={`hidden sm:block text-[9px] sm:text-[11px] uppercase tracking-wide font-medium ${item.text} opacity-75 truncate`}>{item.label}</p>
                                                <p className={`text-sm sm:text-base font-bold leading-none ${item.text}`}>{item.count}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className={`grid grid-cols-1 md:grid-cols-2 ${selectedPanelProject ? 'xl:grid-cols-2 2xl:grid-cols-4' : 'lg:grid-cols-4'} gap-1.5`}>
                                    ...
                                    {memoizedRegions.length > 0 && (
                                        <div className="w-full">
                                            <Combobox
                                                ...
                                                className="h-7 text-[10px] sm:text-xs md:text-sm"
                                            />
                                        </div>
                                    )}
                                    {/* Institute */}
                                    ...
                                    <label className="flex items-center gap-1.5 cursor-pointer">
                                        ...
                                        />
                                        <span className="text-[9px] sm:text-[11px] font-medium uppercase tracking-tight text-muted-foreground">Need Approval</span>
                                    </label>
                                ...
                                <div className="flex flex-wrap gap-2 justify-between items-center pt-1.5 pb-1.5 border-b">
                                    <div className="flex flex-wrap gap-1.5">
                                        <Button onClick={debouncedApplyFilters} size="sm" className="h-7 text-[10px] sm:text-xs px-2">
                                            Apply Filters
                                        </Button>
                                        <Button onClick={exportToPDF} size="sm" variant="outline" className="h-7 text-[10px] sm:text-xs px-2">
                                            PDF
                                        </Button>
                                        <Button onClick={exportToExcel} size="sm" variant="outline" className="h-7 text-[10px] sm:text-xs px-2">
                                            Excel
                                        </Button>
                                    </div>
