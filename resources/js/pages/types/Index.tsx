...
export default function TypeIndex({ types, filters }: Props) {
  ...
  const handleSearchKey = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      router.get('/types', { ...filters, search }, { preserveScroll: true });
    }
  };
        ...
        <Card>
          <CardHeader className="pb-3 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground text-sm">Manage Types</p>
            </div>
          ...
          <CardContent className="pt-6 space-y-6">
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <Input
                type="text"
                placeholder="Search Types... (press Enter)"
                value={search}
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-primary dark:bg-gray-800 text-center">
                    ...
                    <th className="border p-2 text-sm font-medium text-white dark:text-gray-200">Module</th>
                ...
                <tbody>
                  {!types || types.data.length === 0 ? (
                    ...
                    types.data.map((type) => (
                      <tr key={type.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 text-center">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Type <strong>{type.name}</strong> will be permanently deleted.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
